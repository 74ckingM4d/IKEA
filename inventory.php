...
<head>
    ...
    <title>Inventory - Commissary Inventory & Recipe Management System</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-8">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800 ml-4 lg:ml-0" id="pageTitle">Inventory</h2>
                </div>
            ...
            <main class="flex-1 overflow-y-auto p-4 lg:p-8">
                <div class="max-w-7xl mx-auto">
                    <div class="space-y-6">
                        <h1 class="text-2xl font-bold text-gray-900">Raw Inventory</h1>
                        <div id="inventorySearchToolbar" class="hidden">
                            <label for="inventorySearchInput" class="block text-sm font-medium text-gray-700 mb-1">Search raw inventory</label>
                            <input type="search" id="inventorySearchInput" autocomplete="off" placeholder="Search by item, category, supplier…" class="w-full max-w-md px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                        </div>
