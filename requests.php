...
<head>
    ...
    <title>Single Request - Commissary Inventory & Recipe Management System</title>
...
<body class="bg-gray-50">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-8">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800 ml-4 lg:ml-0" id="pageTitle">Single Request</h2>
                </div>
                ...
                <div class="max-w-7xl mx-auto">
                    <div class="space-y-6">
                        <div class="flex justify-between items-center">
                            <h1 class="text-2xl font-bold text-gray-900">Single Request</h1>
                            <button onclick="showAddRequestForm()" id="addRequestBtn" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors" style="display: none;">
                                + New Request
                            </button>
                        </div>
    ...
    <?php
        // Cache-busting for JS assets (important on shared hosting/CDN/browser cache)
        $assetVersion = @filemtime(__DIR__ . '/js/requests.js') ?: time();
    ?>
    <script src="js/api.js?v=<?php echo $assetVersion; ?>"></script>
    <script src="js/store.js?v=<?php echo $assetVersion; ?>"></script>
    <script src="js/ui.js?v=<?php echo $assetVersion; ?>"></script>
    <script src="js/notifications.js?v=<?php echo $assetVersion; ?>"></script>
    <script src="js/layout.js?v=<?php echo $assetVersion; ?>"></script>
    <script src="js/password.js?v=<?php echo $assetVersion; ?>"></script>
    <script src="js/requests.js?v=<?php echo $assetVersion; ?>"></script>
</body>
</html>
