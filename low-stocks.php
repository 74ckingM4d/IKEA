...
<head>
    ...
    <title>Low Stocks - Commissary Inventory & Recipe Management System</title>
...
<body class="bg-gray-50">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-8">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800 ml-4 lg:ml-0" id="pageTitle">Low Stocks</h2>
                </div>
            ...
            <main class="flex-1 overflow-y-auto p-4 lg:p-8">
                <div class="max-w-7xl mx-auto">
                    <div class="space-y-6">
                        ...
                        <div id="lowStocksContainer" class="space-y-4">
    ...
    <script src="js/low-stocks.js"></script>
</body>
</html>
