...
<head>
    ...
    <title>Make Set - Commissary Inventory & Recipe Management System</title>
...
<body class="bg-gray-50">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            <header class="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-8">
                <div class="flex items-center">
                    ...
                    <h2 class="text-lg font-semibold text-gray-800 ml-4 lg:ml-0" id="pageTitle">Make Set</h2>
                </div>
                ...
                <div class="max-w-7xl mx-auto">
                    <div class="space-y-6">
                        <div class="flex justify-between items-center">
                            <h1 class="text-2xl font-bold text-gray-900">Make Set</h1>
                            <button onclick="showAddRecipeForm()" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors" id="addRecipeBtn" style="display: none;">
                                Make Set
                            </button>
                        </div>
    ...
    <script src="js/unitConversions.js"></script>
